...
| `elasticsearch.tls.caCertPath`              | []byte            | no       |              | CA certificate bytes.                                                                                                                                                                                                          |
| `elasticsearch.tls.certPath`                | []byte            | no       |              | Client certificate bytes.                                                                                                                                                                                                      |
| `elasticsearch.tls.keyPath`                 | []byte            | no       |              | Key file bytes.                                                                                                                                                                                                                |

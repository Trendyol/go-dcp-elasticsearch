...
| `elasticsearch.tls.caCert`                  | []byte            | no       |              | CA certificate bytes.                                                                                                                                                                                                          |
| `elasticsearch.tls.cert`                    | []byte            | no       |              | Client certificate bytes.                                                                                                                                                                                                      |
| `elasticsearch.tls.key`                     | []byte            | no       |              | Key file bytes.                                                                                                                                                                                                                |
